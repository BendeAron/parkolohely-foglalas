  ...
  return (
    <div className="fixed inset-0 z-40 flex items-end justify-center sm:items-center">
      ...
      <div
        ...
        className="relative z-10 max-h-[92vh] w-full overflow-y-auto border-t-2 border-[#F5C518]
                   bg-[#1D2125] sm:max-w-md sm:border-2
      ...
      >
        <header className="flex items-start justify-between border-b border-[#39424A] bg-[#262C31] px-5 py-4">
          <div>
            ...
            <h2
              id="drawer-title"
              className="font-['IBM_Plex_Mono'] text-3xl font-medium text-[#F5C518]"
            >
              {spot.spot_number}
            </h2>
          ...
          <div>
            ...
            {eveningBlocked && (
              <p className="mt-2 text-sm text-[#E45B5B]">
                The evening discount needs an arrival at {EVENING_DISCOUNT_FROM_HOUR}:00 or
                later. Pick another discount or move your arrival time.
              </p>
            )}
          </div>
